...
public class EtNumberHelperV2 {
    ...
    public void withView(EditText et, View plus, View sub) {
        ...
        mEt.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {
                    //todo try 后续加的 max=-1 min=1  聚焦获取删除1，退出键盘，再聚焦
                    isCheck = true;
                    return;
                }
    ...
    /**
     * 2.设置限制
     * 在{@link EtNumberHelperV2#withView}
     * {@link EtNumberHelperV2#setViewOption}
     * 之后调用
     *
